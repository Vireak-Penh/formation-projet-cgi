	...
	<div class="body__2">
		...
		<div class="up">
			<h1 class="texte__titre">MyHouse, l'application qui vous permet
				de vous faire livrer oÃ¹ vous voulez... ou presque.</h1>
			<p class="texte__contenu">Avec l'application MyHouse, faites-vous
				livrer n'importe oÃ¹, n'importe quand. Inscrivez-vous et vous
				recevrez les colis de vos voisins, de vos amis ou de votre famille.</p>
		</div>

		<div class="right">
			<h1 class="rechercher__titre1">OÃ¹ est-ce que je veux me faire
				livrer ?</h1>
			<div class="choisir">
